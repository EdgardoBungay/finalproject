...
from log_reg import Logistic_Regression_Type, Logistic_Regression_Quality, Random_Forrest_Type, Random_Forrest_Quality
import log_reg
# import flask
app = Flask(__name__)
...
title_SCV = "Support Vector Classification"
@app.route("/")
def index():
